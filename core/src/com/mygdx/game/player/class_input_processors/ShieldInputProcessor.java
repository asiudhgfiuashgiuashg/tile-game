...
/**
 * handle input for the shield class
 * If the shield class is chosen by the local player, then an instance of this inputprocessor should be added to the end of the multiplexer
