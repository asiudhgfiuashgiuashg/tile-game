...
/**
 * a Shape in this context is a collection of line segments. That is all. There are no requirements for concavity or connectivity etc
 * @author elimonent
 *
 */
public class Shape {
	...
	protected List<LineSeg> lineSegs;
